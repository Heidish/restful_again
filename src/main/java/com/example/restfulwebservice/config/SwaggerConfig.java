...
public class SwaggerConfig {
    ...
    private static final Contact DEFAULT_CONTACT = new Contact("Heidi",
            "http://www.naver.com", "heidish005@gmail.com");

    private static final ApiInfo DEFAULT_API_INFO = new ApiInfo("Nice Api!",
